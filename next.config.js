...
const moduleExports = {
  eslint: {
    ...
    // your project has ESLint warnings. This is acceptable for this codebase
    // which has pre-existing warnings that don't affect functionality.
    ignoreDuringBuilds: true
  },
  typescript: {
    // Warning: Dangerously allow production builds to successfully complete even if
    // your project has type errors. This is needed due to dependency version
    // incompatibilities with @sinclair/typebox requiring TypeScript 5+
  ...
  serverRuntimeConfig: {
    ...
    // Svenska Learning AI Providers
    DEEPSEEK_API_KEY: process.env.DEEPSEEK_API_KEY,
    DEEPSEEK_API_URL: process.env.DEEPSEEK_API_URL,
    KIMI_API_KEY: process.env.KIMI_API_KEY,
    KIMI_API_URL: process.env.KIMI_API_URL,
    FORVO_API_KEY: process.env.FORVO_API_KEY,
    // Local Whisper Transcription
    WHISPER_LOCAL_URL: process.env.WHISPER_LOCAL_URL,
  ...
  publicRuntimeConfig: {
    ...
    V4V_APP_RECIPIENT_VALUE_DEFAULT: process.env.V4V_APP_RECIPIENT_VALUE_DEFAULT,
    V4V_RECIPIENT_VALUE_DEFAULT: process.env.V4V_RECIPIENT_VALUE_DEFAULT,
    // Svenska Learning AI Providers (public)
    DEEPSEEK_API_KEY: process.env.DEEPSEEK_API_KEY,
    DEEPSEEK_API_URL: process.env.DEEPSEEK_API_URL,
    KIMI_API_KEY: process.env.KIMI_API_KEY,
    KIMI_API_URL: process.env.KIMI_API_URL,
